...
distribute(){
    ...
    do
       ...
       scp client ips.txt config.json runClient.sh closeClient.sh $2@${SERVER_ADDR[j-1]}:/home/$2/FHS_PoSpace_IoT
       ssh -t $2@${SERVER_ADDR[j-1]} chmod 777 /home/$2/FHS_PoSpace_IoT/runClient.sh
       ssh -t $2@${SERVER_ADDR[j-1]} chmod 777 /home/$2/FHS_PoSpace_IoT/closeClient.sh
       wait
    done
}
